...
public class EventDB {
     ...
     */
    public void returnEventID(DocumentReference docRef, Event event){
        if (event != null) {
            event.setEventID(docRef.getId());
            event.setDocRef(docRef);
        } else event.setEventID(null);
        ...
        this.db.collection("AllEvents").add(event)
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        returnEventID(documentReference, event);
                    }
                })
    ...
    public void updateEvent(Event event){
        ...
        event.setDocRef(this.db.collection("AllEvents").document(eventID));
    }
}
