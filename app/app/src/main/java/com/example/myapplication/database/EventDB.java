...
public class EventDB {
    ...
    /**
     * Author: Erin-Marie
     * Sets the current eventID of interest as a class attr to return it to activity that created the event
     * this is definitley bad practice, but it is the solution for now
     * @param eventID the eventID generated by Firebase
     */
        ...
        this.db.collection("AllEvents").add(event)
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        returnEventID(documentReference.getId());
                    }
                })
